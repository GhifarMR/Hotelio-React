    ...
    <div className="w-full px-6 md:px-16 my-16 mt-30">
      ...
      <div className="flex justify-between mb-10 flex-col md:flex-row md:items-end">
        ...
        <p className="text-gray-600 max-w-md mt-4 md:mt-0 hover:text-black">
          We understand that very important has different preferences. That’s
          why we provide lots of choice.
        </p>
      </div>
            ...
            <div className="p-4">
              ...
              <a href="#">
                <div className="text-lg mt-1">
                  <span className="text-yellow-400 mr-2">{hotel.ratingStars}</span>
                  {hotel.ratingNumber}
                </div>
              </a>
