...
const ReviewPage = () => {
  ...
  return (
    <div className="bg-[#1f1f1f] py-12 text-white relative">
      ...
      <button
        onClick={scrollLeft}
        className="hidden md:block absolute left-4 top-1/2 -translate-y-1/2 z-10 bg-white hover:bg-yellow-300 text-black p-2 rounded-full transition-colors cursor-pointer"
      >
        ←
      </button>
      ...
      <button
        onClick={scrollRight}
        className="hidden md:block absolute right-4 top-1/2 -translate-y-1/2 z-10 bg-white hover:bg-yellow-300 text-black p-2 rounded-full transition-colors cursor-pointer"
      >
        →
      </button>
